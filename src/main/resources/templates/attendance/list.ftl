    ...
    <div class="container-fluid">
        <div class="row-fluid">
            <div class="span12">
                <h3>
                    员工打卡记录  |
                    <a href="/attendance/doAttendance">打卡</a>
                </h3>
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            <#if (userAttendance.dateTime)?string("yyyyMMdd") == .now?string("yyyyMMdd")>
                                <a href="/attendance/doAttendance">打卡</a>
                            </#if>
                        </td>
                    </tr>
                ...
                <div class="col-md-12 column">
                    ...
                    <#else>
                        <li><a href="/attendance/list?page=${currentPage - 1}&size=${size}">上一页</a></li>
                    </#if>
                    ...
                    <#list 1..userAttendancePage.getTotalPages() as index>
                        ...
                        <#else>
                            <li><a href="/attendance/list?page=${index}&size=${size}">${index}</a></li>
                        </#if>
                    </#list>
                    ...
                    <#else>
                        <li><a href="/attendance/list?page=${currentPage + 1}&size=${size}">下一页</a></li>
                    </#if>
                    </ul>
                </div>
            </div>
